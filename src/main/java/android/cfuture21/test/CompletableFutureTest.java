...
import java.util.concurrent.PoolAccess;
...
//    }
    ...
    public void testToString_incomplete() {
        ...
        assertTrue(f.toString().matches(".*\\[.*Not completed.*\\]"));
        if (testImplementationDetails && isOpenJDKAndroid())
    ...
    static final boolean defaultExecutorIsCommonPool
        = PoolAccess.getCommonPoolParallelism() > 1;
    ...
    public void testDefaultExecutor() {
        ...
        Executor c = PoolAccess.commonPool();
        if (PoolAccess.getCommonPoolParallelism() > 1)
            assertSame(e, c);
        else
            assertNotSame(e, c);
    }
    ...
    public void testMinimalCompletionStage_minimality() {
        ...
        String[] signatureWhitelist = {
            ...
            "copy[]",
            "exceptionallyCompose[interface java.util.function.Function]",
            "exceptionallyAsync[interface java.util.function.Function]",
            "exceptionallyAsync[interface java.util.function.Function, interface java.util.concurrent.Executor]",
            "exceptionallyComposeAsync[interface java.util.function.Function]",
            "exceptionallyComposeAsync[interface java.util.function.Function, interface java.util.concurrent.Executor]",
        };

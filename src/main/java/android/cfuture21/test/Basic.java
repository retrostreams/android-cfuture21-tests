...
import static java.util.concurrent.PoolAccess.commonPool;
...
public class Basic {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("toString() of CompletableFuture: " + new CompletableFuture<String>().toString());
        if (failed > 0) {
            throw new AssertionError(failed + " tests failed!");
        }
    }
}
